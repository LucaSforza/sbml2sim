...
#define RR_VERSION_MAJOR 2
#define RR_VERSION_MINOR 8
...
#define RR_VERSION_STR RR_STRINGIZE(RR_VERSION_MAJOR) "." \
  ...
  RR_STRINGIZE(RR_VERSION_PATCH)
    ...
    #elif (_MSC_VER == 1900)
        #define RR_COMPILER "Microsoft Visual Studio 2015"
    #elif (_MSC_VER == 1700)
...
/**
 * various options of how the get the version std::string.
 */
enum VersionStrOptions
{
    /**
     * the basic version std::string, i.e. "1.0.0"
     */
    VERSIONSTR_BASIC                  = (0x1 << 0),

    /**
     * the compiler std::string
     */
